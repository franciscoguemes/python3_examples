...
# This example is a continuation of the previous one. Here I will show how to delete information from the DB.
# The steps are very easy:
# 1- Open a connection to the DB
# 2- Create a cursor
# 3- Execute SQL statements: In this case a delete statement
...
try:
    delete_statement = ("DELETE FROM Movie WHERE title = 'Blade Runner'")
