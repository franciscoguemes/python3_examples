...
# In this example I am going to show you how to find a simple word in the middle of a very long text with the use
# of the function search.
...
word_regex = "copyright"

# The search returns None if there is no coincidence with the supplied regex or a Match object corresponding to the
# first coincidence.
match = re.search(word_regex,random_text)
print("The following colours where found:")
if match is not None:
    print(f"The first occurence of {word_regex} is between the chars: {match.span()}")
else:
    print("No occurences for {word_regex} where found")